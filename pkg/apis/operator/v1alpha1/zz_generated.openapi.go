...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/aliok/dummy/pkg/apis/operator/v1alpha1.KnativeKafka":       schema_pkg_apis_operator_v1alpha1_KnativeKafka(ref),
		"github.com/aliok/dummy/pkg/apis/operator/v1alpha1.KnativeKafkaSpec":   schema_pkg_apis_operator_v1alpha1_KnativeKafkaSpec(ref),
		"github.com/aliok/dummy/pkg/apis/operator/v1alpha1.KnativeKafkaStatus": schema_pkg_apis_operator_v1alpha1_KnativeKafkaStatus(ref),
	}
}
...
func schema_pkg_apis_operator_v1alpha1_KnativeKafka(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/aliok/dummy/pkg/apis/operator/v1alpha1.KnativeKafkaSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/aliok/dummy/pkg/apis/operator/v1alpha1.KnativeKafkaStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/aliok/dummy/pkg/apis/operator/v1alpha1.KnativeKafkaSpec", "github.com/aliok/dummy/pkg/apis/operator/v1alpha1.KnativeKafkaStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
