...
import (
	...
	operatorv1alpha1 "github.com/aliok/dummy/pkg/apis/operator/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner KnativeKafka
...
func (r *ReconcileKnativeKafka) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set KnativeKafka instance as the owner and controller
...
func newPodForCR(cr *operatorv1alpha1.KnativeKafka) *corev1.Pod {
